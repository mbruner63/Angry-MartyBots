...
function Update () {
	...
	#else
	  #if UNITY_ANDROID && !UNITY_EDITOR
	 motor.movementDirection = OuyaSDK.OuyaInput.GetAxis(0, OuyaController.AXIS_LS_X)* screenMovementRight+
      OuyaSDK.OuyaInput.GetAxis(0, OuyaController.AXIS_LS_Y)* screenMovementForward*-1.0;
	  #else
	...
	var cameraAdjustmentVector : Vector3 = Vector3.zero;
		...
		motor.facingDirection  = OuyaSDK.OuyaInput.GetAxis(0, OuyaController.AXIS_RS_X)* screenMovementRight+
